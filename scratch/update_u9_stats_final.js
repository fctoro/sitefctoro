...
async function run() {
  ...
  // --- STANDINGS (Corrected Group Names and Qualifiers) ---
  const standings = [
    // Group A
    { name: 'Fc Toro Elite', group: 'A', pts: 6, m: 2, v: 2, n: 0, d: 0, bm: 7, bc: 0, rank: 1, qual: true },
    { name: 'CSP', group: 'A', pts: 4, m: 2, v: 1, n: 1, d: 0, bm: 2, bc: 1, rank: 2, qual: true },
    { name: 'Fc Colonne', group: 'A', pts: 1, m: 2, v: 0, n: 1, d: 1, bm: 0, bc: 3, rank: 3, qual: false },
    { name: 'PAC', group: 'A', pts: 0, m: 2, v: 0, n: 0, d: 2, bm: 1, bc: 6, rank: 4, qual: false },
    // Group B
    { name: 'ASF', group: 'B', pts: 4, m: 2, v: 1, n: 1, d: 0, bm: 1, bc: 0, rank: 1, qual: true },
    { name: 'Jacot FP', group: 'B', pts: 2, m: 2, v: 0, n: 2, d: 0, bm: 0, bc: 0, rank: 2, qual: true }, // Added qual: true
    { name: 'Condor EF', group: 'B', pts: 1, m: 1, v: 0, n: 1, d: 0, bm: 0, bc: 0, rank: 3, qual: false },
    { name: 'Valencia', group: 'B', pts: 0, m: 1, v: 0, n: 0, d: 1, bm: 0, bc: 1, rank: 4, qual: false }
  ];
  ...
  console.log('Standings for U9 have been corrected with standard group names and qualifiers.');
