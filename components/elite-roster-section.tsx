                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="absolute inset-0 z-10 flex items-end justify-center px-[2%] lg:bottom-0 lg:left-[-4%] lg:right-[18%] lg:top-3 lg:items-stretch lg:justify-start lg:px-0">
                        {player.photo_url ? (
                          <div className="relative h-[95%] w-full lg:h-full">
                            <ElitePlayerPhoto
