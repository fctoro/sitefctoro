/**
 * Script: rebuild-stats.js
 * Rewrites flag-day-stats.ts completely with correct UTF-8 encoding.
 */
const fs = require('fs');
const path = require('path');

const target = path.join(__dirname, '..', 'data', 'flag-day-stats.ts');

const content = `export const logoMap: Record<string, string> = {
...
export const flagDayMatches: Record<string, MatchResult[]> = {
  ...
  U13: [
    { home: 'Fc Toro Elite', away: 'Fc Flambo', scoreHome: 3, scoreAway: 1, group: 'A' },
    { home: 'Fc Seth', away: 'Perfection', scoreHome: 0, scoreAway: 1, group: 'A' },
    { home: 'Fc Toro Elite', away: 'Perfection', scoreHome: 3, scoreAway: 0, group: 'A' },
    { home: 'Fc Seth', away: 'Fc Flambo', scoreHome: 2, scoreAway: 1, group: 'A' },
    { home: 'Fc Toro Elite', away: 'Fc Seth', scoreHome: 1, scoreAway: 1, group: 'A' },
    { home: 'Fc Flambo', away: 'Perfection', scoreHome: 4, scoreAway: 1, group: 'A' },
    { home: 'Valencia', away: 'FC MDM', scoreHome: 2, scoreAway: 3, group: 'B' },
    { home: 'PAC', away: 'ASF', scoreHome: 1, scoreAway: 7, group: 'B' },
    { home: 'Valencia', away: 'ASF', scoreHome: 0, scoreAway: 1, group: 'B' },
    { home: 'PAC', away: 'FC MDM', scoreHome: 1, scoreAway: 4, group: 'B' },
    { home: 'Valencia', away: 'PAC', scoreHome: 0, scoreAway: 1, group: 'B' },
    { home: 'FC MDM', away: 'ASF', scoreHome: 0, scoreAway: 2, group: 'B' },
  ],
  U15: [
    { home: 'Fc Toro Elite', away: 'Idelo FC', scoreHome: 2, scoreAway: 0, group: 'A' },
    { home: 'ASF', away: 'Legend EF', scoreHome: 1, scoreAway: 0, group: 'A' },
    { home: 'Fc Toro Elite', away: 'Legend EF', scoreHome: 2, scoreAway: 0, group: 'A' },
    { home: 'ASF', away: 'Idelo FC', scoreHome: 0, scoreAway: 3, group: 'A' },
    { home: 'Fc Toro Elite', away: 'ASF', scoreHome: 2, scoreAway: 0, group: 'A' },
    { home: 'Idelo FC', away: 'Legend EF', scoreHome: 2, scoreAway: 1, group: 'A' },
    { home: 'Fc Flambo', away: 'Fc MDM', scoreHome: 1, scoreAway: 0, group: 'B' },
    { home: 'Condor', away: 'Fc Toro PV', scoreHome: 0, scoreAway: 0, group: 'B' },
    { home: 'Fc Flambo', away: 'Fc Toro PV', scoreHome: 0, scoreAway: 1, group: 'B' },
    { home: 'Condor', away: 'Fc MDM', scoreHome: 6, scoreAway: 1, group: 'B' },
    { home: 'Fc Flambo', away: 'Condor', scoreHome: 1, scoreAway: 2, group: 'B' },
    { home: 'Fc MDM', away: 'Fc Toro PV', scoreHome: 0, scoreAway: 0, group: 'B' },
  ],
  U17: [
  ...
  U21: [
    { home: 'Fc Toro Elite', away: 'Fc Flambo', scoreHome: 3, scoreAway: 0, group: 'A' },
    { home: 'Ade 30', away: 'SLG', scoreHome: 1, scoreAway: 1, group: 'A' },
    { home: 'Fc Toro Elite', away: 'Ade 30', scoreHome: 1, scoreAway: 2, group: 'A' },
    { home: 'SLG', away: 'Fc Flambo', scoreHome: 2, scoreAway: 1, group: 'A' },
    { home: 'Fc Toro Elite', away: 'SLG', scoreHome: 3, scoreAway: 0, group: 'A' },
    { home: 'Fc Flambo', away: 'Ade 30', scoreHome: 0, scoreAway: 1, group: 'A' },
    { home: 'VAC', away: 'Ac Perfection', scoreHome: 1, scoreAway: 0, group: 'B' },
    { home: 'Jacot', away: 'Aigle noir', scoreHome: 2, scoreAway: 4, group: 'B' },
    { home: 'VAC', away: 'Aigle noir', scoreHome: 0, scoreAway: 0, group: 'B' },
    { home: 'Jacot', away: 'Ac Perfection', scoreHome: 2, scoreAway: 1, group: 'B' },
    { home: 'VAC', away: 'Jacot', scoreHome: 3, scoreAway: 0, group: 'B' },
    { home: 'Ac Perfection', away: 'Aigle noir', scoreHome: 1, scoreAway: 5, group: 'B' },
  ],
};
...
console.log('flag-day-stats.ts rebuilt successfully with clean UTF-8.');
